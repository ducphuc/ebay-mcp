...
export interface paths {
  ...
  '/payout': {
    ...
    /** @description <div class="msgbox_important"><p class="msgbox_importantInDiv" data-mc-autonum="&lt;b&gt;&lt;span style=&quot;color: #dd1e31;&quot; class=&quot;mcFormatColor&quot;&gt;Important! &lt;/span&gt;&lt;/b&gt;"><span class="autonumber"><span><b><span style="color: #dd1e31;" class="mcFormatColor">Important!</span></b></span></span> Due to EU &amp; UK Payments regulatory requirements, an additional security verification via Digital Signatures is required for certain API calls that are made on behalf of EU/UK sellers, including all <b>Finances API</b> methods. Please refer to <a href="/develop/guides/digital-signatures-for-apis " target="_blank">Digital Signatures for APIs</a> to learn more on the impacted APIs and the process to create signatures to be included in the HTTP payload.</p></div><br><span class="tablenote"><b>Note:</b>  The <b>Finances API</b> does not support <a href="https://www.ebay.com/sellercenter/ebay-for-business/multi-user-account-access" target="_blank">Team Access</a>. Financial information, such as payouts or transactions, is only returned for the user that makes the call. You cannot use any of the methods in this API to return financial information for another user.</span><br>This method is used to retrieve the details of one or more seller payouts. By using the <b>filter</b> query parameter, users can retrieve payouts processed within a specific date range, and/or they can retrieve payouts in a specific state.<br><br><span class="tablenote"><b>Note:</b> Only payouts less than 5 years in the past can be retrieved.</span><br>There are also pagination and sort query parameters that allow users to control the payouts that are returned in the response.<br><br>If no payouts match the input criteria, an empty payload is returned.<br><br>For split-payout cases, which are <b>only</b> available to sellers in mainland China, this method will return the <b>payoutPercentage</b> for the specified payout. This value indicates the current payout percentage allocated to a payout instrument. This method will also return the <b>convertedToCurrency</b> and <b>convertedTo</b> response fields set to CNY value and the <b>payoutReference</b>, the unique identifier reference (not true payout). <br><br>By using the <b>filter</b> query parameter, users can retrieve the two true(actual) payouts associated with a <b>payoutReference</b>.<br><br><span class="tablenote"><b>Note:</b> For more information on split payouts, see <a href="/api-docs/split-payout/playbook.html" target="_blank">Mainland China Split Payout Playbook</a>.</span><br>This method returns mock data in the sandbox environment. */
  ...
  '/payout_summary': {
    ...
    /** @description <div class="msgbox_important"><p class="msgbox_importantInDiv" data-mc-autonum="&lt;b&gt;&lt;span style=&quot;color: #dd1e31;&quot; class=&quot;mcFormatColor&quot;&gt;Important! &lt;/span&gt;&lt;/b&gt;"><span class="autonumber"><span><b><span style="color: #dd1e31;" class="mcFormatColor">Important!</span></b></span></span> Due to EU &amp; UK Payments regulatory requirements, an additional security verification via Digital Signatures is required for certain API calls that are made on behalf of EU/UK sellers, including all <b>Finances API</b> methods. Please refer to <a href="/develop/guides/digital-signatures-for-apis " target="_blank">Digital Signatures for APIs</a> to learn more on the impacted APIs and the process to create signatures to be included in the HTTP payload.</p></div><br><span class="tablenote"><b>Note:</b>  The <b>Finances API</b> does not support <a href="https://www.ebay.com/sellercenter/ebay-for-business/multi-user-account-access" target="_blank">Team Access</a>. Financial information, such as payouts or transactions, is only returned for the user that makes the call. You cannot use any of the methods in this API to return financial information for another user.</span><br>This method is used to retrieve cumulative values for payouts in a particular state, or all states. The metadata in the response includes total payouts, the total number of monetary transactions (sales, refunds, credits) associated with those payouts, and the total dollar value of all payouts.<br><br><span class="tablenote"><b>Note:</b> Only payouts less than 5 years in the past can be retrieved.</span><br>If the <b>filter</b> query parameter is used to filter by payout status, only one payout status value may be used. If the <b>filter</b> query parameter is not used to filter by a specific payout status, cumulative values for payouts in all states are returned.<br><br>The user can also use the <b>filter</b> query parameter to specify a date range, and then only payouts that were processed within that date range are considered.<br><br>This method returns mock data in the sandbox environment. */
  ...
  '/transaction_summary': {
    ...
    /** @description <div class="msgbox_important"><p class="msgbox_importantInDiv" data-mc-autonum="&lt;b&gt;&lt;span style=&quot;color: #dd1e31;&quot; class=&quot;mcFormatColor&quot;&gt;Important! &lt;/span&gt;&lt;/b&gt;"><span class="autonumber"><span><b><span style="color: #dd1e31;" class="mcFormatColor">Important!</span></b></span></span> Due to EU &amp; UK Payments regulatory requirements, an additional security verification via Digital Signatures is required for certain API calls that are made on behalf of EU/UK sellers, including all <b>Finances API</b> methods. Please refer to <a href="/develop/guides/digital-signatures-for-apis " target="_blank">Digital Signatures for APIs</a> to learn more on the impacted APIs and the process to create signatures to be included in the HTTP payload.</p></div><br><span class="tablenote"><b>Note:</b>  The <b>Finances API</b> does not support <a href="https://www.ebay.com/sellercenter/ebay-for-business/multi-user-account-access" target="_blank">Team Access</a>. Financial information, such as payouts or transactions, is only returned for the user that makes the call. You cannot use any of the methods in this API to return financial information for another user.</span><br>The <b>getTransactionSummary</b> method retrieves cumulative information for monetary transactions. If applicable, the number of payments with a <code>transactionStatus</code> equal to <code>FUNDS_ON_HOLD</code> and the total monetary amount of these on-hold payments are also returned.<br><br><span class="tablenote"><b>Note:</b> For a complete list of transaction types, refer to <a href="/develop/api/sell/finances_api#sell-finances_api-transaction-gettransactions.transactiontypeenum " target="_blank ">TransactionTypeEnum</a>.</span><br>Refer to the <b>filter</b> field for additional information about each filter and its use.<br><br><span class="tablenote"><b>Note:</b> Unless a <code>transactionType</code> filter is used to retrieve a specific type of transaction (e.g., <code>SALE</code>, <code>REFUND</code>, etc.,) the <a href="/develop/api/sell/finances_api#sell-finances_api-transaction-gettransactionsummary.transactionsummaryresponse.creditcount">creditCount</a> and <a href="/develop/api/sell/finances_api#sell-finances_api-transaction-gettransactionsummary.transactionsummaryresponse.creditamount">creditAmount</a> response fields both include <i>order sales</i> and <i>seller credits</i> information. That is, the <b>count</b> and <b>value</b> fields do not distinguish between these two types monetary transactions.</span><br><span class="tablenote"><b>Note:</b> <b>getTransactionSummary</b> will only return data on transactions that occurred less than five years in the past.</span> */
...
export interface components {
  schemas: {
    ...
    Amount: {
      ...
      convertedFromCurrency?: components['schemas']['CurrencyCodeEnum'];
      ...
      convertedToCurrency?: components['schemas']['CurrencyCodeEnum'];
    ...
    BalanceAdjustment: {
      ...
      adjustmentType?: components['schemas']['BookingEntryEnum'];
    };
    ...
    /** @description This type is the base response type used by the <b>getBillingActivities</b> method. */
    ...
    /**
     * @description This enumerated type contains the values used to indicate whether the dollar value of a monetary transaction is a positive or negative value. | - **CREDIT**: This enumeration value indicates that the dollar value of the monetary transaction is a credit to the seller's account. Typically, the <code>SALE</code> and <code>CREDIT</code> transaction types are credits to the seller's account. For sales proceeds in the <code>FUNDS_ON_HOLD</code> state, the dollar value shown in the <b>onHoldAmount</b> will also show as seller credit. - **DEBIT**: This enumeration value indicates that the dollar value of the monetary transaction is a debit to the seller's account. Typically, the <code>REFUND</code>, <code>DISPUTE</code>, <code>SHIPPING_LABEL</code>, and <code>TRANSFER</code> transaction types are debits to the seller's account. Note that the shipping label functionality will initially only be available to a select number of sellers.
     * @enum {string}
     */
    BookingEntryEnum: 'CREDIT' | 'DEBIT';
    ...
    FilterField: {
      field?: string;
      negated?: boolean;
      range?: components['schemas']['RangeValue'];
      set?: string[];
      value?: string;
    };
    ...
    Payout: {
      ...
      payoutStatus: components['schemas']['PayoutStatusEnum'];
    ...
    Reference: {
      ...
      referenceType?: components['schemas']['ReferenceTypeEnum'];
    };
    /**
     * @description An enumerated type that identifies the type of reference ID provided. | - **CANCELLATION_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of a cancellation. - **CASE_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of a case. - **INVOICE**: This enumeration value indicates that the ID provided refers to the unique identifier of an invoice. It indicates that the seller will be billed by invoice, and fees will not be deducted from the payout.<br><br><b>Note</b>: This enumeration value applies only to <code>NON_SALE_CHARGE transactions</code>. - **ITEM_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of an item. It is used to identify listing-related fees.<br><br><b>Note</b>: This enumeration value applies only to NON_SALE_CHARGE transactions. - **ORDER_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of an order.<br><br><b>Note</b>: This enumeration value applies only to sales/transactions-related fees. - **PAYMENTS_DISPUTE_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of a payment dispute. - **REFUND_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of a refund. - **LOAN_REPAYMENT_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of a repayment transaction.<br><br><b>Note</b>: This is an externally assigned reference ID. It cannot be used to filter transactions. - **RETURN_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of a return. - **PAYOUT_ID**: This enumeration value indicates that the ID provided refers to the unique identifier of a payout.
     * @enum {string}
     */
    ReferenceTypeEnum:
      | 'CANCELLATION_ID'
     ...
     * @enum {string}
     */
    RegionTypeEnum: 'COUNTRY' | 'STATE_OR_PROVINCE';
    ...
    Tax: {
      /** @description The type of tax applied to the transaction. */
      taxType?: components['schemas']['TaxTypeEnum'];
    ...
    Transaction: {
      ...
      bookingEntry: components['schemas']['BookingEntryEnum'];
      ...
      transactionStatus: components['schemas']['TransactionStatusEnum'];
    ...
    /**
     * @description This enumeration type lists the different possible states of a monetary transaction, including payouts to sellers, refunds to buyers, and credits to a seller's account. <p> <span class="tablenote"><b>Note:</b> The enumerations <strong>COMPLETED</strong> and <strong>FAILED </strong> apply to monetary transactions with the <strong>transactionType</strong> of <code>TRANSFER</code>. They only apply to monetary transactions where eBay is billing the seller for reimbursement of a charge. An example of a transfer is a seller reimbursing eBay for a buyer refund.</span></p> | - **FUNDS_ON_HOLD**: This enumeration value indicates that the funds for the monetary transaction are currently being held. - **FUNDS_PROCESSING**: This enumeration value indicates that the monetary transaction is being processed. - **FUNDS_AVAILABLE_FOR_PAYOUT**: This enumeration value indicates that the corresponding transaction is available for a seller payout. - **PAYOUT**: This enumeration value indicates that the corresponding transaction has been paid out to the seller's account. - **COMPLETED**: This enumeration value indicates that the corresponding transaction has completed and funds have been transferred to eBay. No additional action is required. See <b>Note</b>. - **FAILED**: This enumeration value indicates that the corresponding transaction failed and funds have not been transferred to eBay. This does not indicate release of seller's responsibilities for required reimbursement. See <b>Note</b>.
     * @enum {string}
     */
    ...
    TransactionSummaryResponse: {
      ...
      adjustmentBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      balanceTransferBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      creditBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      disputeBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      loanRepaymentBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      nonSaleChargeBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      onHoldBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      purchaseBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      refundBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      shippingLabelBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      transferBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
      ...
      withdrawalBookingEntry?: components['schemas']['BookingEntryEnum'];
      /**
       * Format: int32
    ...
    /**
     * @description This enumeration type defines the type of monetary transactions retrieved with the <b>getTransactions</b> method. | - **SALE**: This enumeration value indicates that the monetary transaction type is the sale of an order. - **REFUND**: This enumeration value indicates that the monetary transaction type is a buyer refund. - **CREDIT**: This enumeration value indicates that the monetary transaction type is a credit to the seller's account. - **DISPUTE**: This enumeration value indicates that the monetary transaction type involves a payment dispute between the buyer and seller. - **SHIPPING_LABEL**: This enumeration value indicates that the monetary transaction type involves eBay billing the seller for the purchase of an eBay shipping label. Note that the shipping label functionality will initially only be available to a select number of sellers.<br><br><b>Note</b>: eBay shipping label transactions paid through PayPal are not currently supported by the Finances API, and will not be returned in the response. - **TRANSFER**: This enumeration value indicates that the monetary transaction type involves a seller transferring money to eBay for reimbursement of a charge. For example, when a seller reimburses eBay for a buyer refund. - **NON_SALE_CHARGE**: This enumeration value indicates that the monetary transaction involves a non-transactional fee billed to the seller by eBay. These fees can include listing and listing upgrade fees, eBay store or other subscription fees, and ad fees. - **ADJUSTMENT**: This enumeration value indicates that the monetary transaction type is an adjustment (credit or debit) to the seller's account. - **WITHDRAWAL**: This enumeration value indicates that the monetary transaction type is an on-demand payout to the seller's account. If funds are available, a seller can request an on-demand payout.<br><br><b>Note</b>: On-demand payout is not available for sellers who are already on a <b>daily</b> payout schedule. In order to initiate an on-demand payout, a seller must be on a <b>weekly</b>, <b>bi-weekly</b>, or <b>monthly</b> payout schedule. - **LOAN_REPAYMENT**: This enumeration value indicates that the monetary transaction type is a loan repayment transaction.<br><br><b>Note</b>: eBay Seller Capital financing is only available in select marketplaces. Refer to  <a href="/api-docs/sell/finances/overview.html#loans" target="_blank">Marketplace availability for eBay Seller Capital funding program</a> for current marketplace eligibility. - **PURCHASE**: This enumeration value indicates that the monetary transaction type is the purchase of an item by a seller using spendable funds.<br><br><b>Note</b>: This transaction type is currently only applicable in the US marketplace.
     * @enum {string}
     */
    TransactionTypeEnum:
      | 'SALE'
...
export interface operations {
  getOrderEarnings: {
    parameters: {
      query?: {
        ...
        filter?: string;
        /** @description This parameter configures the number of orders to return per page of the result set. Use this parameter in conjunction with the <b>offset</b> parameter to control the pagination of the output. <br><br> For example, if <b>offset</b> is set to <code>10</code> and <b>limit</b> is set to <code>10</code>, the method retrieves orders 11 thru 20 from the result set. <br><br> <span class="tablenote"><strong>Note:</strong> This feature employs a zero-based list, where the first page in the results set has an offset value of <code>0</code>. </span><br> <b>Maximum:</b> <code>200</code> <br> <b>Default:</b> <code>20</code> */
        limit?: string;
        ...
        offset?: string;
        /** @description This parameter can be used to specify the sort order of the results. Currently, sorting is supported by order creation date. <br><br><b>Default:</b> Results returned in ascending order sorted by <b>orderCreationDate</b>, with earliest creation date first. */
        sort?: string;
      };
      header: {
        /** @description This header identifies the seller's eBay marketplace.<br><br>See <a href="/develop/api/sell/request_headers#marketplace-id-values" target="_blank ">Request Headers</a> for the marketplace ID values.<br><br><span class="tablenote"><b>Note:</b> If a marketplace ID value is not provided, the default value of <code>EBAY_US</code> is used.</span> */
  ...
  getPayout: {
    parameters: {
      ...
      path: {
        /** @description This path parameter is used to specify the unique identifier of the payout being retrieved. <br><br>Use the <a href="/develop/api/sell/finances_api#sell-finances_api-payout-getpayouts">getPayouts</a> method to retrieve payout IDs, or check Seller Hub to get the payout ID. */
        payout_Id: string;
      };
      cookie?: never;
    };
  ...
  getTransfer: {
    parameters: {
      ...
      path: {
        /** @description This path parameter is used to specify the unique identifier of the <code>TRANSFER</code> transaction type you wish to retrieve.<br><br>Use the <a href="/develop/api/sell/finances_api#sell-finances_api-transaction-gettransactions">getTransactions</a> method to retrieve this value by setting the <b>transactionType</b> filter to <code>TRANSFER</code>. The <b>transfer_id</b> value will then be returned in the <b>transaction_id</b> field of the response. */
        transfer_Id: string;
      };
      cookie?: never;
    };
