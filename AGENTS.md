...
A local [MCP](https://modelcontextprotocol.io) server exposing a registry-derived tool set covering 100% of eBay's Sell APIs. TypeScript/Node.js (ESM), built with `@modelcontextprotocol/sdk`, Effect-backed validation, a Zod SDK adapter, and OpenAPI-generated types.
